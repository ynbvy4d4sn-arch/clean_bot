...
from tactical_forecast import (
    ...
    write_tactical_score_v2_outputs,
    write_tactical_score_v3_outputs,
)
...
def _run_single_impl(args: argparse.Namespace, diagnostics) -> dict[str, object]:
    ...
    try:
        ...
        tactical_calibration_paths = write_tactical_forecast_calibration_outputs(
            prices=prices,
            params=params,
            tickers=active_tickers,
            as_of=as_of,
        ...
        tactical_score_v2_paths = write_tactical_score_v2_outputs(
            prices=prices,
            params=params,
            tickers=active_tickers,
            as_of=as_of,
        ...
        tactical_score_v3_paths = write_tactical_score_v3_outputs(
            tactical_forecast=tactical_forecast,
            output_dir=OUTPUT_DIR,
        )
        tactical_output_paths = {
            ...
            **tactical_score_v2_paths,
            **tactical_score_v3_paths,
        }
